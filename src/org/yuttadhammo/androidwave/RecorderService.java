...
//			Log.d("Recorder", "run()");
		...
		private void mainLoop()
		{
			if (filename == null)
			{
				...
				Time t = new Time();
				t.setToNow();
				filename = Environment.getExternalStorageDirectory().getPath()+"/Sound Recordings/" + t.format2445() + ".wav";
...
//			int[] samplingRates = {44100, 22050, 16000, 11025, 8000};
			int[] samplingRates = {22050, 16000, 11025, 8000}; // Space/quality trade-off.
